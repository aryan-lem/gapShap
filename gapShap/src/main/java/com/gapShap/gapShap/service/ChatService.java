...
public List<ConversationDTO> getConversationsForUser(User user) {
    ...
    return conversations.stream()
            ...
            .sorted((c1, c2) -> {
                ...
                Long timestamp1 = c1.getLastMessage() != null ? 
                    c1.getLastMessage().getSentAt() : 
                    (c1.getCreatedAt() != null ? c1.getCreatedAt().getTime() : 0L);
                    
                Long timestamp2 = c2.getLastMessage() != null ? 
    ...
    public List<MessageDTO> getMessagesForConversation(Long conversationId, User currentUser, int page, int size) {
        ...
        List<Message> messages = messageRepository.findByConversationOrderBySentAtAsc(conversation, pageable);
    ...
    public void markMessagesAsRead(User user, Long conversationId) {
        ...
        List<Message> unreadMessages = messageRepository.findByConversationAndIsReadFalseOrderBySentAtDesc(conversation);
